...
int main()
{
    ...
    {
        HeroStatus heroStatus; //state the hero status
        int width = 4;  //map width
        int height = 5; //map height
        Node ***map = generateMap(width, height); //three stars
    ...
    else if(choice == 1) //test the test cases
    {
        ...
        else if(testCaseNumber == 2)
        {
            ...
            int height = 4; //map height
            Node ***map = generateMap(width, height);
            cout << "adding hero: " << addThing(map, width, height, -1, 0, HERO, 1) << endl; // should be false, 0
            printMap(map, width, height);
            ...
            printMap(map, width, height);
            cout << "adding monster: " << addThing(map, width, height, 3, 2, DRAGON, 2) << endl;
            printMap(map, width, height);
            cout << "adding monster: " << addThing(map, width, height, 3, 2, DRAGON, 3) << endl;
            printMap(map, width, height);
            cout << "adding monster: " << addThing(map, width, height, 3, 2, SKELETON, 1) << endl;
            printMap(map, width, height);
        ...
        else if(testCaseNumber == 4)
        {
            ...
            //remove dragon in vampire and mace position
            cout << "removeing dragon: " << removeThing(map, width, height, 3, 2, DRAGON, 1) << endl;
            printMap(map, width, height);
            cout << "Linked list nodes at (0,0): "; printLinkedList(map[0][0]);
            cout << "Linked list nodes at (1,1): "; printLinkedList(map[1][1]);
            cout << "Linked list nodes at (2,1): "; printLinkedList(map[1][2]);
            ...
            //remove mace, sword dagger
            cout << "removeing Mace 3: " << removeThing(map, width, height, 3, 3, MACE, 1) << endl;
            printMap(map, width, height);
            cout << "Linked list nodes at (0,0): "; printLinkedList(map[0][0]);
            cout << "Linked list nodes at (1,1): "; printLinkedList(map[1][1]);
            cout << "Linked list nodes at (2,1): "; printLinkedList(map[1][2]);
            ...
            cout << "removeing Sword 2: " << removeThing(map, width, height, 3, 3, SWORD, 3) << endl;
            printMap(map, width, height);
            cout << "Linked list nodes at (0,0): "; printLinkedList(map[0][0]);
            cout << "Linked list nodes at (1,1): "; printLinkedList(map[1][1]);
            cout << "Linked list nodes at (2,1): "; printLinkedList(map[1][2]);
            ...
            cout << "removeing DAGGER D: " << removeThing(map, width, height, 3, 3, DAGGER, 2) << endl;
            printMap(map, width, height);
            cout << "Linked list nodes at (0,0): "; printLinkedList(map[0][0]);
            cout << "Linked list nodes at (1,1): "; printLinkedList(map[1][1]);
            cout << "Linked list nodes at (2,1): "; printLinkedList(map[1][2]);
        ...
        else if(testCaseNumber == 11)
        {
            ...
            addThing(map, width, height, 1, 1, SKELETON, 1);
            addThing(map, width, height, 1, 1, VAMPIRE, 1);
            addThing(map, width, height, 1, 1, DRAGON, 1);
            printMap(map, width, height);
            printHeroStatus(heroStatus);
            cout << "getMonsterCount returns " << getMonsterCount(map, width, height) << endl;
            cout << "Hero is " << (heroStatus.alive?"alive":"dead") << endl;
